...
typedef struct
{
    volatile  __evenaccess struct st_cmtw   *regs;              /* Pointer to the registers */
    ...
    volatile __evenaccess uint8_t           *ir_cm;             /* Pointer to compare match ICU IR register */
    volatile __evenaccess uint8_t           *ipr_cm;            /* Pointer to compare match ICU IPR register */
    volatile __evenaccess uint8_t           *ier_cm;            /* Pointer to compare match ICU IER register */
    uint8_t                                 cm_enable_mask;     /* Compare match IEN mask bit */
    volatile __evenaccess uint8_t           *ir_oc0;            /* Pointer to output compare 0 ICU IR register */
    volatile __evenaccess uint8_t           *ipr_oc0;           /* Pointer to output compare 0 ICU IPR register */
    volatile __evenaccess uint8_t           *ier_oc0;           /* Pointer to output compare 0 ICU IER register */
    uint8_t                                 oc0_enable_mask;    /* Output compare 0 IEN mask bit */
    volatile __evenaccess uint8_t           *ir_oc1;            /* Pointer to output compare 1 ICU IR register */
    volatile __evenaccess uint8_t           *ipr_oc1;           /* Pointer to output compare 1 ICU IPR register */
    volatile __evenaccess uint8_t           *ier_oc1;           /* Pointer to output compare 1 ICU IER register */
    uint8_t                                 oc1_enable_mask;    /* Output compare 1 IEN mask bit */
    volatile __evenaccess uint8_t           *ir_ic0;            /* Pointer to input capture 0 ICU IR register */
    volatile __evenaccess uint8_t           *ipr_ic0;           /* Pointer to input capture 0 ICU IPR register */
    volatile __evenaccess uint8_t           *ier_ic0;           /* Pointer to input capture 0 ICU IER register */
    uint8_t                                 ic0_enable_mask;    /* Input capture 0 IEN mask bit */
    volatile __evenaccess uint8_t           *ir_ic1;            /* Pointer to input capture 0 ICU IR register */
    volatile __evenaccess uint8_t           *ipr_ic1;           /* Pointer to input capture 0 ICU IPR register */
    volatile __evenaccess uint8_t           *ier_ic1;           /* Pointer to input capture 0 ICU IER register */
